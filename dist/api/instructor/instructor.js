...
exports.router.get("/courses/approved", auth_1.isAuthorizedUser, auth_1.isInstructor, async_wrapper_1.default(instructor_controller_1.default.getCoursesByInstructor));
exports.router.get("/courses/pending", auth_1.isAuthorizedUser, auth_1.isInstructor, async_wrapper_1.default(instructor_controller_1.default.getPendingCoursesByInstructor));
